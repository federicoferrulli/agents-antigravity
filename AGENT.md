...
- Aderisci a `docs/rules/continuous-learning.md`. Sii proattivo: quando risolvi un problema inedito o crei un workflow utile, chiedi all'utente di documentarlo immediatamente come regola o skill.
...
## Workflow Iterativo
1. **Ricerca**: Consulta `docs/rules/` e `skills/` per le linee guida rilevanti.
